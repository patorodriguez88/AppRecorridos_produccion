...
$(".guardarProducto").click(function(){
  ...
  $.ajax({
          data:{'ConfirmoEntrega':1,'Cs':cs,'Name':receptorname,'Dni':receptordni,'Obs':receptorobservaciones,'Retirado':retirado,'Razones':razones,'Etiquetas':etiquetas},
          type: "POST",
...
function cargasistemaNoEntrega(){
  ...
  $.ajax({
          data:{'ConfirmoNoEntrega':1,'Cs':cs,'Name':receptorname,'Dni':receptordni,'Obs':receptorobservaciones,'Retirado':retirado,'Razones':razones},
          type: "POST",
          url: "https://www.caddy.com.ar/AppRecorridos/Proceso/php/funciones.php",
          success: function(response)
          {
